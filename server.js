...
require("./app/routes/master-pelanggan/master-pelanggan.route")(app);
require("./app/routes/user-s/user-s.routes")(app);
require("./app/routes/history-telkom/history-telkom.route")(app);
